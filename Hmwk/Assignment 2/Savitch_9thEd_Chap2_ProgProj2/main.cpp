...
int main(int argc, char** argv) {
    ...
    do
    {
    cout<<"This program will calculate an employee's retroactive pay"<<endl;
    cout<<"for 6 months, their new annual salary, and their new monthly salary"<<endl;
    cout<<"given their previous annual salary and a 7.6% increase."<<endl;
    cout<<endl;
    cout<<"Please enter the employee's previous annual salary in dollars: ";
    cin>>previous_salary;
    retroactive_pay=(previous_salary*0.076)*6;
    new_salary=(previous_salary*0.076)+previous_salary;
    new_monthly=new_salary/12;
    cout<<"The amount of retroactive pay due for 6 months is: ";
